...
namespace GravyBot.Commands
{
    internal static class Extensions
    {
        ...
        public static bool HasAttribute<TAttribute>(this ParameterInfo method) where TAttribute : Attribute => method.GetCustomAttributes<TAttribute>().Any();
        ...
        public static TAttribute GetAttribute<TAttribute>(this ParameterInfo method) where TAttribute : Attribute => method.GetCustomAttributes<TAttribute>().FirstOrDefault();
